...
[![](WordNets.png){fig-align="center" width="700"}](https://sites.google.com/unipv.it/linked-wordnets/wordnets?authuser=0)
...
-   Numerous substantive difficulties with entries that do not map neatly:
    -   [*\*aghlu-*](https://indo-european.info/pokorny-etymological-dictionary/whnjs.htm) *(IEW*, p. 8) 'dark cloud; rainy weather': new hypernym (of both 'cloud' and 'weather') needed
