...
-   Categories are automatically drawn from Wikidata and applied when it makes sense.
...
-   Implementing methodology from Historical Linguistics, the Comparative Method, in the reconstruction of earlier hyperspaces
-   Upsides:
    1.  fully automated
    2.  requires low CPU processing
-   Downsides:
    1.  doesn't distinguish multiple senses (polysemy)
    2.  only performs well (relatively) on smaller corpora
...
-   Earlier, we talked about what led us to this topic -- DERBi PIE

-   With hyperspaces generated for each descendant and reconstructed language, our models would give us numerical scores
